...
import type { Inmate } from '../context/InmatesDataContext';
...
const CentralInmatesList = () => {
  ...
  // Greffier peut modifier — les autres voient en lecture seule
  ...
  const handleClick = (inmate: Inmate) => {
  ...
  return (
    <div className="central-inmates-container">
      ...
      <div className="central-filters">
        ...
        {canEdit && (
          <button className="add-inmate-btn" onClick={() => navigate('/inmates/new')}>
            + Nouveau Détenu
          </button>
        )}
      </div>
        ...
        {filteredInmates.map((inmate) => (
          ...
          >
            ...
            <div className="central-details">
              ...
              <div className="central-row">Naissance: {inmate.dob} ({inmate.age} ans) | Sexe: {inmate.sex === 'Male' ? 'Homme' : 'Femme'}</div>
